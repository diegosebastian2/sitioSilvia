...
<html class="no-js" lang="">
    ...
    <body>
      <div class="container-fluid content">
        ...
        <div class="monedas acordeon-container">
            <a href="#" class="acordeon-titulo">Monedas y Billetes<span class="toggle-icon"></span></a>
            <div class="acordeon-content" id="mone">
              <div class="grilla">
                <div class="item">
                  <p>No hay imagenes de muestra</p>
                </div>

              </div>
            </div>
        </div>
        <div class="carpetas acordeon-container">
            <a href="#" class="acordeon-titulo">Carpetas<span class="toggle-icon"></span></a>
            <div class="acordeon-content" id="carp">
        ...
        <div class="portadocumentos acordeon-container">
            <a href="#" class="acordeon-titulo">Portadocumentos<span class="toggle-icon"></span></a>
            <div class="acordeon-content" id="port">
        ...
        <div class="envases acordeon-container">
            <a href="#" class="acordeon-titulo">Envases<span class="toggle-icon"></span></a>
            <div class="acordeon-content" id="enva">
        ...
        <div class="promocionales acordeon-container">
            <a href="#" class="acordeon-titulo">Promocionales<span class="toggle-icon"></span></a>
            <div class="acordeon-content" id="prom">
              <h5 class="titulogrilla"></h5>
              <div class="grilla">
                <div class="item">
        ...
        <script>
          $(document).ready(function(){
                ...
                var id = '#'+url.slice(url.length-4, url.length);
                console.log(id);
                $(id).slideDown(400);
                $(id).prev(".acordeon-titulo").addClass("open");

                $(".acordeon-titulo").click(function(){

                 var contenido=$(this).next(".acordeon-content");
